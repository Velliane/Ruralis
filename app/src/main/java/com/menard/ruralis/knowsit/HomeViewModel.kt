...
class HomeViewModel(private val knowsItRepository: KnowsItRepository, private val googleApiRepository: GoogleApiRepository, private val firestoreDataRepository: FirestoreDataRepository): ViewModel() {

    val randomKnowsIt = MutableLiveData<KnowsIt>()

    private val listFavoritesLiveData = MutableLiveData<PlaceForList>()
